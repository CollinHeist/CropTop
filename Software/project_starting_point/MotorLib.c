 ...
 * Summary:     This file contains functions to operate TI DRV8872DDAR motor
				driver IC. The device operates via PWM signals generated by 
				PIC32 output compare modules 1 and 2 and responds to motor
				fault warning interrupts. 
...
/* **************************************************************************
 * Function:    void MotorLib_PortSetup()
...
{
    //generate an interrupt once each mS.
    OpenTimer2((T2_ON | T2_SOURCE_INT |T2_PS_1_16), PR2_VALUE);
    //set interrupt to priority group to 2, subgroup 0
