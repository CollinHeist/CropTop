...
#ifndef __DISPLAY_LIBRARY_H__
    #define __DISPLAY_LIBRARY_H__

    // Hardware Configuration
    #define CS_PIN          (BIT_5)             // GPU_CS is Pin 61, RA5
    #define CS_PORT         (IOPORT_A)
    #define CS_LOW()        (LATACLR = CS_PIN)
    #define CS_HIGH()       (LATASET = CS_PIN)
    #define PD_PIN          (BIT_7)             // GPU_PWR_DWN is Pin 5, RE7
    #define PD_PORT         (IOPORT_E)
    #define PD_LOW()        (LATECLR = PD_PIN)
    #define PD_HIGH()       (LATECLR = PD_PIN)
    #define SCLK_PIN        (BIT_4)             // GPU_SCLK is Pin 70, RE4
    #define SCLK_PORT       (IOPORT_E)
    #define MISO_PIN        (BIT_3)             // GPU_MISO is Pin 9, RE3
    #define MISO_PORT       (IOPORT_E)
    #define MOSI_PIN        (BIT_0)             // GPU_MOSI is Pin 72, RD0
    #define MOSI_PORT       (IOPORT_D)
